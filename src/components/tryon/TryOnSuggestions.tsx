  ...
  return (
    <div className="rounded-2xl p-5 h-full flex flex-col relative overflow-hidden" style={{ backgroundImage: `url(${bgShowroom})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      ...
      <div className="flex items-center justify-center gap-2 mb-6 relative z-10">
        <Sparkles className="w-4 h-4 text-primary" /><h3 className="font-display text-xl font-bold text-foreground italic">Gợi Ý Cho Bạn</h3><Sparkles className="w-4 h-4 text-primary" />
      </div>
