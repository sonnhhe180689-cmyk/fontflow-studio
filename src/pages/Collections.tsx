              ...
              <div className="bg-card rounded-lg overflow-hidden shadow-sm group cursor-pointer relative">
                ...
                <div className="p-4 text-center">
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-3">
                    <button onClick={() => onAddToCart(col)} className="btn-outline-gold text-xs py-2 w-full px-[14px]">
                      <ShoppingCart className="w-3 h-3 inline mr-1" /> Thêm Vào Giỏ
                    </button>
                    <Link to="/thu-vong-co?camera=1" className="w-full">
                      <button className="btn-gold text-xs px-4 w-full py-[16px]">✨ Thử Ngay</button>
                    </Link>
                  </div>
                </div>
              </div>
